...
const metadata = await conn.newsletterMetadata("jid", "120363421350428668@newsletter");
if (metadata.viewer_metadata === null) {
  await conn.newsletterFollow("120363421350428668@newsletter");
  console.log("SHAGEE MD CHANNEL FOLLOW ✅");
}
